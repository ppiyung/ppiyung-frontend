<template>
    <b-tab title="정보 수정하기" active>
          <h5>{{memberInfo.memberNickname}}  </h5> <br>
        <div>
    <b-row>
      ...
      <b-col lg="4" class="pb-2">
        ...
        ></b-form-input>
         ...
         <b-col lg="4" class="pb-2">
          <b-button
          variant="primary"
          @click="updateSubmit">수정하기</b-button>
      </b-col>
    </b-row>
...
export default {
  ...
  created() {//new Date().toISOString().substr(0,10)
    ...
    memberInfoObj.memberBirth = new Date(memberInfoObj.memberBirth).toISOString().substring(0,10);
